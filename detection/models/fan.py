...
class FAN(BaseModule):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=False, pretrained=None, out_index=-1, use_checkpoint=False, out_channel=[], init_cfg=None):
        super(FAN, self).__init__(init_cfg)
        img_size = to_2tuple(img_size)
        ...
        self.out_norm = []
        for i, channel in enumerate(self.out_channel):
            layer = nn.LayerNorm(channel)
        ...
        # self.init_cfg = dict(type='Pretrained',
        #     checkpoint=self.pretrained) 

        if isinstance(pretrained, str):
            print("use init_cfg to load pretrained weights")
    ...
    def forward(self, x):
        ...
        for i, feats in enumerate(x):
            ...
            outs.append(feats.permute(0, 3, 1, 2).contiguous())
        return outs
    ...
    def __init__(self, pretrained, **kwargs):
        ...
        super(fan_tiny_8_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=192, depth=depth, backbone=backbone,
                 ...
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=7, out_channel=[128, 256, 192, 768], use_checkpoint=True)
    ...
    def __init__(self, pretrained, **kwargs):
        ...
        super(fan_small_12_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=384, depth=depth, backbone=backbone,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=9, out_channel=[128, 256, 384, 768], use_checkpoint=True)
    ...
    def __init__(self, pretrained, **kwargs):
        ...
        super(fan_base_12_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=448, depth=depth, backbone=backbone,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=15, out_channel=[128, 256, 448, 768], use_checkpoint=True)
