...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node=8 --nnodes=$rank_num \
	--node_rank=$rank_index --master_addr="10.148.236.57" --master_port=3349 \
	main.py  ../../raid/imagenet_raw/ --model fan_base_16_p4_hybrid_token -b 64 --sched cosine --epochs 350 \
	...
	--smoothing 0.1 \
	--output ../trained_models/fan_base_16_p4_hybrid_stl/ \
	--amp --model-ema \
	--token-label  --cls-weight 1.0 --dense-weight 1.0 \
	--offline-model ../trained_models/fan_base_16_p4_hybrid_token_labeler/train/20220902-165215-fan_base_16_p4_hybrid_token-224/model_best.pth.tar \
