...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node=8 --nnodes=$rank_num \
	--node_rank=$rank_index --master_addr="10.148.236.108" --master_port=3349 \
	train_token_labeler.py  ../../raid/imagenet_raw/ --model fan_large_16_p4_hybrid_token -b 64 --sched cosine --epochs 350 \
	...
	--smoothing 0.1 \
	--output ../trained_models/fan_large_16_p4_hybrid_token_labeler/ \
	--amp --model-ema \
